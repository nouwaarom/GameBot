...
void protobuf_AssignDesc_movemessage_2eproto() {
  ...
  MoveMessage_Move_descriptor_ = MoveMessage_descriptor_->nested_type(0);
  static const int MoveMessage_Move_offsets_[1] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MoveMessage_Move, name_),
  };
...
void protobuf_AddDesc_movemessage_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\021movemessage.proto\022\013aiconnector\"\240\002\n\013Mov"
...
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900
#if !defined(_MSC_VER) || _MSC_VER >= 1900
const int MoveMessage_Move::kNameFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900
      ...
      case 1: {
        if (tag == 10) {
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            "aiconnector.MoveMessage.Move.name"));
        } else {
          goto handle_unusual;
        }
